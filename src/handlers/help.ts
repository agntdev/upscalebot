...
const HELP = "Use Upload image to prepare a photo, then choose Standard 2× or Pro 4×. Join the group first to receive your Standard credit. Use Pricing to send a payment proof for manual approval.";
